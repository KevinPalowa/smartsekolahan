...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#exampleModal">Add New Siswa</a>
                ...
                <tbody>
                    ...
                    foreach ($jurusan as $m) : ?>
                        <tr>
                            <th scope="row"><?= $i ?></th>
                            <td><?= $m['jurusan'] ?></td>
                            <td><a href="<?= base_url('jurusan/edit/' . $m['id']) ?>" class="badge badge-success mr-3">Edit</a><a href="<?= base_url('jurusan/delete/' . $m['id']) ?>" class="badge badge-danger">Delete</a></td>
                        </tr>
                    <?php $i++;
                    endforeach ?>
                </tbody>
