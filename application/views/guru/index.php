...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="<?= base_url('guru/add') ?>" class="btn btn-primary mb-3">Add New Guru</a>
                ...
                <tbody>
                    ...
                    foreach ($guru as $m) : ?>
                        <tr>
                            ...
                            <td><a href="<?= base_url('guru/edit/' . $m['id']) ?>" class="badge badge-success mr-3">Edit</a><a href="<?= base_url('guru/delete/' . $m['id']) ?>" class="badge badge-danger tombol-hapus">Delete</a></td>
                        </tr>
                    <?php $i++;
                    endforeach ?>
                </tbody>
